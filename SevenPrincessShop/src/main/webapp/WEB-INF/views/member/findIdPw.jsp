...
<table class='tbl'>
	<tbody>
		<tr style="height: 45px"><td colspan="2" style="text-align: center;background-color: #d0b8b8e6"><h4>아이디 찾기</h4></td></tr>
		<tr>
...
<table class='tbl'>
	<tbody>
		<tr style="height: 45px"><td colspan="2" style="text-align: center;background-color: #d0b8b8e6" ><h4>비밀번호 찾기</h4></td></tr>
		<tr>
